<template>
	<div id="vueSwiper">
		<h4>横向无缝切换</h4>
		<nut-swiper :pagination-visibile="true" direction="horizontal" :swiper-data="dataImgItem">
		...
		<h4>横向切换</h4>
		<nut-swiper :pagination-visibile="true" direction="horizontal" :swiper-data="dataImgItem" :can-dragging="false" :pagination-visible="true">
			<div v-for="(item, index) in dataImgItem" :key="index" class="nut-swiper-slide">
				<img :src="item.imgSrc" style="max-width: 100%;" />
			</div>
		</nut-swiper>
		...
		<h4>纵向自动播放</h4>
		<nut-swiper direction="vertical" :auto-play="3000" :swiper-data="dataImgItem">
			<div v-for="(item, index) in dataImgItem" :key="index" class="nut-swiper-slide">
				<img :src="item.imgSrc" style="max-width: 100%;" />
			</div>
		</nut-swiper>
