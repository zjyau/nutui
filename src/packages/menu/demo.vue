<template>
	<div>
		...
		<nut-menu :is-visible="visible.isVisible1" :list="list1" type="simple" @close="switchMenu('isVisible1', 1)" @choose="chooseMenu" />
		...
		/>
		<nut-menu
			:is-visible="visible.isVisible10"
			:list="list4"
			type="multiple"
			col="3"
			mulstyle="style3"
		...
		<nut-menu :is-visible="visible.isVisible11" @close="switchMenu('isVisible11', 5)">
