<template>
	<div class="textinput-demo">
		...
		<div>
			<nut-cell>
				<span slot="title">
					<nut-textinput :clear-btn="false" v-model="val2" label="无清空按钮：" placeholder="请输入内容" />
				</span>
			</nut-cell>
			<nut-cell>
				<span slot="title">
			...
			<nut-cell>
				<span slot="title">
					<nut-textinput placeholder="请输入内容" v-model="val4" label="无边框：" :has-border="false" />
				</span>
			</nut-cell>
		</div>
		<h4>使用input原生属性</h4>
		<div>
			<nut-cell>
				<span slot="title">
					<nut-textinput placeholder="maxlength=5" maxlength="5" label="限制文字数：" :outline="false" :has-border="false" />
				</span>
			</nut-cell>
			<nut-cell>
				<span slot="title">
