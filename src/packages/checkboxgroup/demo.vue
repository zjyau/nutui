<template>
	<div class="demo-list">
		...
		<div>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup ref="checkboxGroup" :check-box-data="data1" v-model="group1" /></span>
			</nut-cell>
			<p>{{ group1 }}</p>
		...
		<div>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :check-box-data="data2" v-model="group2" /></span>
			</nut-cell>
		</div>
		<h4>自定义尺寸</h4>
		<div>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :size="'small'" :check-box-data="data3" v-model="group3" /></span>
			</nut-cell>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :size="'base'" :check-box-data="data3" v-model="group4" /></span>
			</nut-cell>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :check-box-data="data33" :size="'small'" v-model="group5" /></span>
			</nut-cell>
		...
		<div>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :check-box-data="data33" v-model="group6" :animation="false" /></span>
			</nut-cell>
			<p>选择状态：{{ group6 }}</p>
		...
		<div>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :check-box-data="data5" v-model="group7" :vertical="true" /></span>
			</nut-cell>
		...
		<div>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :check-box-data="data6" v-model="group0" @change="changeEvt" /></span>
			</nut-cell>
			<p>选择状态：{{ group0 }}</p>
		...
		<div>
			<nut-cell>
				<span slot="title"><nut-checkboxgroup :custom-class="'my-checkbox'" :check-box-data="data7" v-model="group8" /></span>
			</nut-cell>
		</div>
	</div>
</template>
