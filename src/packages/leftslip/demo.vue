<template>
	<div>
		...
		<div>
			<nut-leftslip>
				...
				<div slot="slipbtns" class="slipbtns">
					<a href="javascript:;" @click="delSlipItem">删除</a><a href="javascript:;" class="favorite">收藏</a>
				</div>
			</nut-leftslip>
		</div>
		<p>单个按钮</p>
		<div>
			...
			<nut-leftslip only-del-btn @oneDelete="oneDel">
		...
		<div>
			<nut-leftslip>
				...
				<div slot="slipbtns" class="slipbtns">
					...
					<a href="javascript:;" class="favorite org1"><nut-icon type="trolley" size="20px" color="#fff" /></a>
					<a href="javascript:;" class="favorite org2"><nut-icon type="cross" size="15px" color="#fff" /></a>
		...
		<div>
			<nut-leftslip v-for="(item, index) in list" :key="item.id" ref="leftslip">
				<div slot="slip-main" class="slip-main">
					...
					<a class="addr-edit" href="javascript:void(0)" />
				</div>
				<div slot="slipbtns" class="slipbtns">
					<a href="javascript:;" @click="delItem(index)">删除</a><a href="javascript:;" class="favorite">收藏</a>
				</div>
			</nut-leftslip>
		</div>
	</div>
