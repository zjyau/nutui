<template>
	<div>
		...
		<h4>图标按钮-小</h4>
		<div class="white-bg">
			<nut-button type="actived" shape="circle" icon="tick" small />
		</div>

		<h4>图标按钮-大</h4>
		<div class="white-bg">
			<nut-button type="actived" shape="circle" icon="tick" />
		</div>
		...
		<div class="white-bg">
			...
			<nut-button type="actived" shape="circle" icon="tick" color="rgb(0,0,0)" small />
