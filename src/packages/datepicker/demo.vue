<template>
	<div class="demo-list">
		<nut-noticebar :close-mode="true" v-if="!isMobile">
			此 Demo 在 PC 端浏览器与移动端浏览器体验差异较大，建议在 Android 或 iOS 设备上体验。
		</nut-noticebar>
		<h4>基本用法</h4>
		<div>
			<nut-cell :show-icon="true" :is-link="true" @click.native="switchPicker('isVisible')">
				<span slot="title">
					<label>日期选择</label>
				</span>
			...
			<nut-cell :show-icon="true" :is-link="true" @click.native="switchPicker('isVisible1')">
				<span slot="title">
					<label>日期选择</label>
				</span>
			...
			<nut-cell :show-icon="true" :is-link="true" @click.native="switchPicker('isVisible2')">
				<span slot="title">
					<label>日期时间选择</label>
				</span>
			...
			<nut-cell :show-icon="true" :is-link="true" @click.native="switchPicker('isVisible3')">
				<span slot="title">
					<label>时间选择</label>
				</span>
			...
			<nut-cell :show-icon="true" :is-link="true" @click.native="switchPicker('isVisible4')">
				<span slot="title">
					<label>时间选择</label>
				</span>
			...
			<nut-cell :show-icon="true" :is-link="true" @click.native="switchPicker('isVisible5')">
				<span slot="title">
					<label>时间选择</label>
				</span>
		...
		<nut-datepicker
			...
			title="请选择日期时间"
			type="datetime"
			start-date="2000-11-10 12:08"
			end-date="2030-10-05 10:04"
			default-value="2018-11-02 11:08"
